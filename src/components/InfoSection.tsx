...
export const InfoSection = () => {
    ...
    return (
        <section className="py-24 bg-gray-50 dark:bg-gray-950 transition-colors duration-500 overflow-hidden relative">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    {cards.map((card, index) => (
                        ...
                        >
                            <div className="h-full bg-white dark:bg-gray-900 p-10 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] border border-gray-100 dark:border-gray-800 hover:border-amber-500/30 dark:hover:border-amber-500/30 transition-all duration-500 flex flex-col items-center text-center relative overflow-hidden">
                                ...
                                <h3 className="relative z-10 text-2xl font-bold text-gray-900 dark:text-white mb-5">
                                    {card.title}
                                </h3>
                                <p className="relative z-10 text-gray-600 dark:text-gray-400 leading-8 text-[1.05rem] text-justify dark:font-light">
                                    {card.content}
                                </p>
